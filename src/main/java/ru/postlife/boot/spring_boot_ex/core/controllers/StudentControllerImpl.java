...
import ru.postlife.boot.spring_boot_ex.core.converters.StudentConverter;
...
public class StudentControllerImpl implements StudentController {
    ...
    public List<StudentDto> getAllStudents() {
        return studentService.findAllStudents().stream().map(studentConverter::entityToDto).collect(Collectors.toList());
    }
